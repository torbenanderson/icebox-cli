# E3-06 Execution Spec

## Objective

- Deliver E3-06 (Unseal via enclave).
- Backlog contract: Decryption requires the agent's Ed25519 private key, unwrapped from the Secure Enclave at moment of use
...
- In scope:
  - Decryption requires the agent's Ed25519 private key, unwrapped from the Secure Enclave at moment of use
- Out of scope:
...
- AC1: E3-06 behavior matches backlog description: Decryption requires the agent's Ed25519 private key, unwrapped from the Secure Enclave at moment of use
...
- [x] docs/plan/spec/PKT-E3-06-work-item.md
