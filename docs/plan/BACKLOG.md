...
| E1-19 | Error code artifact | Maintain machine-readable error-code registry at `docs/reference/error-codes.json` as a current runtime reference surface; keep it synced with runtime code mapping and add a sync test before introducing code generation |
